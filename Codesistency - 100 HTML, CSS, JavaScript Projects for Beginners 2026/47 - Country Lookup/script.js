...
function displayCountry(country) {
  ...
  resultDiv.innerHTML = `<div class="flag">${country.flag}</div>
...
// add function that randomizes which country appears on page load by default
// or add function that uses user location data to page load on visit
// add currency symbols for countries
